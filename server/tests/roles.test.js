...
const ROUTES = [
  ...
  ['get', `/api/reports/export?type=expenses&format=xlsx&${RANGE}`, FIN],
  ['get', `/api/reports/export?type=summary&format=xlsx&${RANGE}`, FIN],
  ['get', '/api/statements', FIN],
  ['get', `/api/statements/${ID}`, FIN],
